...
public class FireBullets : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (BirdMovement.bossHealth >= 71 || BirdPhase1.bossHealth >= 71) // Stage 1
        {
        ...
        if ((BirdMovement.bossHealth >= 31 && BirdMovement.bossHealth < 71) || (BirdPhase1.bossHealth >= 31 && BirdPhase1.bossHealth < 71)) // Stage 2
        {
